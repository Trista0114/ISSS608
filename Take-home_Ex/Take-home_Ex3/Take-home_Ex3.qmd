...
I extracted feature importance from the regression tree using pruned_tree. The top features were:

-   Size (3768.25)
-   Highest_Floor (2868.25)
-   Parking (1347.7)
-   Units (1126.59)
-   Year (915.63)

A bar plot of feature importance highlighted that Size and Highest_Floor were the most influential predictors of property prices, while features like Bus_Stop had small impact.
...
### 6.4.1 Predicted vs Actual Plot
